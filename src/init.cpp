...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/soscoin-project/soscoin>";
    const std::string URL_WEBSITE = "<https://soscoin.org>";
