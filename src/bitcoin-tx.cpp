...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s soscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  soscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soscoin transaction") + "\n" +
              "  soscoin-tx [options] -create [commands]   " + _("Create hex-encoded soscoin transaction") + "\n" +
              "\n";
